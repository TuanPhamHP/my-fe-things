					...
					>
						...
						>
							<div class="sm:flex sm:items-start">
								...
								>
									<Icon name="solar:danger-triangle-line-duotone" class="text-red-900" size="20px" />
									<!-- <ExclamationTriangleIcon class="h-6 w-6 text-red-600" aria-hidden="true" /> -->
								</div>
								<div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
									<DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Đăng xuất</DialogTitle>
									<div class="mt-2">
