<template>
	...
	>
		<div @click="$router.push(detailData.link)" class="cursor-pointer relative">
...
<script lang="ts">
	...
	export default {
		...
		methods: {
			getImageUrl() {
				// @ts-ignore
				return new URL(`/assets/images/documentation/${this.detailData.previewImage}`, import.meta.url) as string;
			},
		},
	};
</script>
