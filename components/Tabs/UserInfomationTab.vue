<template>
	<div>
		...
		<div class="py-8 flex gap-6 items-center">
			...
			<div>
				...
				<p
					...
					:class="[
						getAccountUserStatusTextColor(detailData.is_active),
						detailData.is_active ? 'is-active' : 'is-disabled',
					]"
				>
					{{ detailData.is_active ? 'Đang hoạt động' : 'Ngừng hoạt động' }}
				</p>
			</div>
		</div>
		<div class="grid grid-cols-2 gap-4">
			...
			<div class="col-span-1">
				<p class="text-md text-gray-900 mb-2">Mã nhân viên</p>
...
<script lang="ts">
	...
	import { getAccountUserStatusTextColor } from '../../helpers/formatter';
	export default {
