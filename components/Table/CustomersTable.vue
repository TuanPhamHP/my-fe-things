								...
								<tbody class="divide-y divide-gray-200 bg-white">
									...
									>
										...
										<td
											...
											:class="[getCustomerStatusTextColor(item.status?.id)]"
...
<script lang="ts">
	...
	import { getCustomerStatusTextColor, formatDateDMY } from '../../helpers/formatter';
	export default {
		components: {
			Menu,
			MenuButton,
