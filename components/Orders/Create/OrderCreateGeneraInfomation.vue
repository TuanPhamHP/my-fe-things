		...
		<div class="pt-4 pb-4 grid grid-cols-2 gap-x-4 gap-y-3">
			<div class="col-span-1">
				<AutocompleteNormal
					...
					:expand-icon-name="'ic:outline-arrow-drop-down'"
...
<script lang="ts">
	...
	export default {
		...
		mounted() {
			if (this.listMechandiseTypes.length && !this.merchandise_type_id) {
				this.merchandise_type_id = this.listMechandiseTypes[0].id || null;
			}
		},
		data() {
			return {
