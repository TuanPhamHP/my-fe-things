<template>
	<button
		class="flex items-center justify-center gap-[12px] rounded-md shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 text-slate-900 dark:text-white"
		@click="toggleTheme"
	>
