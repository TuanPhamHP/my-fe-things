...
const [count, setCount] = useState(0);`"
				...
				<p className="text-slate-900 dark:text-white my-5 leading-8 text-lg ">
					Trong đó:
					<br />
					<b className="pl-5 inline-block">`count`</b>: Biến chứa giá trị state hiện. <br />
					<b className="pl-5 inline-block">`setCount`</b>: Hàm sử dụng để cập nhật giá trị <b>`count`.</b> <br />
					<b className="pl-5 inline-block">`1`</b>: Giá trị khởi tạo cho state<b>`count`.</b>
				</p>
...
`"
				...
				<p className="text-slate-900 dark:text-white my-5 leading-8 text-lg ">
					Trong đó:
					<br />
					<b className="pl-5 inline-block">`Block 01`</b>: Là blockcode sẽ được thực thi tùy theo điều kiện của{' '}
					<b>`dependencies`</b>
					<br />
					<b className="pl-5 inline-block">`Cleanup function`</b>: Function sẽ chạy khi <b>Component Unmount</b>{' '}
					hoặc <b>Dependencies</b> thay đổi <br />
					<b className="pl-5 inline-block">`dependencies`</b>: Là một mảng chứa các giá trị khiến effect được kích hoạt
					lại. <br /><br />
					...
					<b className="pl-5 inline-block">`[]`</b>: useEffect sẽ thực thi 1 lần duy nhất khi{' '}
					<b>`Component Mounted`;</b>
					<br />
					<b className="pl-5 inline-block">`[a,b,c]`</b>: useEffect sẽ thực thi khi{' '}
					<b>bất kì biến nào trong mảng `a,b,c` thay đổi;</b>
					<br />
					<b className="pl-5 inline-block">` `</b>: useEffect sẽ thực thi khi{' '}
