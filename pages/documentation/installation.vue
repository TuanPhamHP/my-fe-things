	...
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-6">
		<div class="w-full flex gap-2">
			<div class="grow">
				...
				<p className="text-slate-900 dark:text-white mt-5 leading-8"><b>Note:</b> Required Node &gt;= 14 on local</p>
				<p className="text-slate-900 dark:text-white mt-5 md:text-2xl underline leading-8">
					<b>B1: Init</b>
				</p>
				<p className="text-slate-900 dark:text-white mt-5 leading-8">
				...
				<FakeTerminalUI :textCoppy="'npm install create-react-app my-app -g'">
					<p>npm install create-react-app my-app -g</p>
				</FakeTerminalUI>
				<p className="text-slate-900 dark:text-white mt-5 leading-8">
					<b
