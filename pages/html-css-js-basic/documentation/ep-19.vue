		...
		<div class="w-full flex gap-2">
			<div class="grow page-data">
				...
				<p class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
					Ở bài này chúng ta sẽ tìm hiểu về JS DOM.
				</p>
				<p class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
					JavaScript DOM (Document Object Model), có thể hiểu là việc chúng ta Model hoá cấu trúc của HTML thành dạng
					Object trong Javascript, thông qua đó thể hiện được cấu trúc toàn trang web thông qua mô hình dạng cây phân
					cấp. Mỗi phần tử được coi như 1 nút của cây.
					<br />
					Ngoài ra, bằng việc Model hoá ta có thể dùng JavaScript để thực hiện bài toán CRUD của mọi phần tử trong cây
					DOM.
					<br />
					Ví dụ: ta có thể thêm, xoá, sửa thẻ, class v.v
				</p>
				<div>
					<img
						src="https://www.linode.com/docs/guides/traversing-the-dom/dom-tree-example.png"
						alt=""
						class="block max-w-[100%] mx-auto dark:invert"
					/>
					<p class="text-slate-900 text-center italic dark:text-white my-5 leading-8 text-lg text-content">Cây DOM</p>
				</div>

				<p class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
					Như ta có thể thấy, mỗi một phần tử (element) HTML đã được viết lại dưới dạng <b>object</b> và biểu diễn như
					một nút của cây DOM, trong đó mỗi object đều chứa rất nhiều thông tin như
					<b>atrributes, text, parents, childs ...</b> Mà thông qua các thông tin này ta có thể thao tác với phần tử
					theo ý muốn bằng JavaScript.
					<br />
					<br />
