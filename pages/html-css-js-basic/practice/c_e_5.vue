<template>
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-3 xl:p-3 3xl:p-6 pr-0">
		<div class="w-full flex gap-2">
			<PageHeading text="Bài 4 - Register/Login Form" addOnClass="text-left" markedAs="env" />
		</div>
		<div class="py-2 mb-5">
		...
		<p className="text-slate-900 dark:text-white mt-5">
			1/ Dựng giao diện <b>Đăng nhập</b> và <b>Đăng ký</b> như mẫu với tính năng:
		</p>
		<ul class="pl-5">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				- Click vào dòng
				<span class="cursor-pointer hover:underline text-blue-400">Đăng ký ngay</span>: hiển thị form đăng ký
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				- Click vào dòng
				<span class="cursor-pointer hover:underline text-blue-400">Đăng nhập ngay</span>: hiển thị form đăng nhập
			</li>
		</ul>
		<p className="text-slate-900 dark:text-white mt-5">
			2/ Cho phép người dùng đăng ký tài khoản thông qua việc nhập nội dung vào ô input, khi người dùng click button
			<b>`Đăng ký`</b>, thì kiểm tra thông tin đăng ký sau với điều kiện sau:
		</p>
		<ul class="pl-5">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b> -</b> Tên người dùng: Không được để trống, dài ít nhất 8 ký tự.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b> -</b> email: Không được để trống, không trùng với các email đã có.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b> -</b> Mật khẩu: Không được để trống, dài ít nhất 8 ký tự.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b> -</b> Xác nhận mật khẩu: Không được để trống, phải trùng với mật khẩu ở trên.
			</li>
		</ul>
		<p className="text-slate-900 dark:text-white mt-5">
			3/ Nếu đăng ký thành công, lưu thông tin tài khoản vừa đăng ký vào mảng dữ liệu, cho phép người dùng đăng nhập ở
			tab
			<b>Đăng nhập</b>
		...
		<PageHeading text="Gợi ý làm bài" addOnClass="text-left" markedAs="env" />
		<p className="text-slate-900 dark:text-white my-3">
			<b>Câu 1:</b>
			<br />
			<br />
			Tạo giao diện có cả 2 form <b>Đăng ký</b> và <b>Đăng nhập</b>, sau đó viết hàm
			<FilePath>showLoginForm()</FilePath> và <FilePath>showRegistrationForm()</FilePath> trong đó:
		</p>
		<ul class="pl-5">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<FilePath>showLoginForm()</FilePath> hàm này sẽ sử dụng bài toán classList để ẩn form Đăng ký và hiển thị form
				Đăng nhập.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<FilePath>showRegistrationForm()</FilePath> hàm này sẽ sử dụng bài toán classList để ẩn form Đăng nhập và hiển
				thị form Đăng ký.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				Gán các hàm trên tương ứng vào event 'click' của các nút:
				<span class="cursor-pointer hover:underline text-blue-400 px-2">Đăng ký ngay</span>
				<span class="cursor-pointer hover:underline text-blue-400 px-2">Đăng nhập ngay</span>
			</li>
		</ul>
		...
		<p className="text-slate-900 dark:text-white my-3">
			...
			<br />
			<br />
			Tạo mảng <b>listAccounts</b> để lưu lại danh sách các tài khoản đăng ký thành công.
		</p>
		<VCodeBlock :code="b0" highlightjs lang="javascript" theme="tomorrow-night-bright" />
		<p className="text-slate-900 dark:text-white my-3">
			Tạo hàm
			<FilePath>handleSubmitRegisForm()</FilePath>, hàm này sẽ xử lý:
		</p>
		<ul class="pl-5">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Lấy dữ liệu từ ô input trong form bằng cách sử dụng DOM. Ví dụ:
				<br />
				<br />
				<VCodeBlock :code="b1" highlightjs lang="javascript" theme="tomorrow-night-bright" />
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Kiểm tra dữ liệu với điều kiện cho ở đề bài. Ví dụ:
				<br />
				<br />
				<VCodeBlock :code="b2" highlightjs lang="javascript" theme="tomorrow-night-bright" />
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Nếu toàn bộ dữ liệu đều thoả mãn điều kiện thì lưu lại vào mảng <b>listAccounts</b> rồi báo thành công.
				Ví dụ:
				<br />
				<br />
		...
		<p className="text-slate-900 dark:text-white my-3">
			...
			<br />
			<br />
			Tương tự cầu, tạo hàm
			<FilePath>handleSubmitLoginForm()</FilePath>, hàm này sẽ xử lý:
		</p>
		<ul class="pl-5">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Lấy dữ liệu từ ô input trong form bằng cách sử dụng DOM. Ví dụ:
			...
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Kiểm tra dữ liệu xem có trùng khớp với tài khoản trong mảng <b>listAccounts</b> không. Ví dụ:
				<br />
				<br />
				<VCodeBlock :code="b4" highlightjs lang="javascript" theme="tomorrow-night-bright" />
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content">
				<b>-</b> Xử lý các trường hợp có/không tương ứng với yêu cầu.
			</li>
		</ul>
		<p className="text-slate-900 dark:text-white my-3">
			<b>Lưu ý:</b>
			Các phần hướng dẫn ở trên không phải là một bài làm hoàn chỉnh, chúng chỉ đưa cho các bạn các hướng giải quyết và
			ví dụ.
		</p>
		<DocNextPage v-if="false" :pagination="pagePagination" />
	</div>
</template>
<script lang="ts">
	...
	export default {
		...
		data() {
			return {
				...
				b0: ` // mảng 'listAccounts' dùng để lưu lại danh sách các tài khoản đăng ký
const listAccounts = []`,
				b1: `function handleSubmitRegisForm(){
// ... các logic xử lý khác

	// Ví dụ cách lấy dữ liệu của thẻ input có id là 'inputUserName'
	const inputUserName = document.querySelector('#inputUserName');
	const name = inputUserName.value;

// ... các logic xử lý khác
}`,
				b2: ` // Ví dụ kiểm tra độ dài tên người dùng:
if (name.length < 8) {
	alert('Lỗi tên người dùng: tối thiểu 8 kí tự')
}`,

				b3: ` // Giả sử đã thoả mãn hết điều kiện dữ liệu, ta tạo ra một object để lưu lại các dữ liệu
const account = {
	id: listAccounts.length,
	name: name,
	email: email,
	password: password
};
...
alert('Đăng ký thành công. Bạn có thể đăng nhập bằng email/password vừa đăng ký');`,
				b4: `function handleSubmitLoginForm(){
// ... các logic xử lý khác

	// Ví dụ cách lấy dữ liệu của thẻ input có id là 'inputUserEmail'
	const inputUserEmail = document.querySelector('#inputUserEmail');
	const email = inputUserEmail.value;

// ... các logic xử lý khác
}`,
				b5: ` // Ví dụ kiểm tra xem trong mảng listAccounts có phần tử thoả mãn không:
const matchAccount = listAccounts.filter(function(){
	// logic kiểm tra tài khoản trùng khớp ....
})`,
			};
		},
		watch: {
