<template>
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-3 xl:p-6">
		<div class="w-full flex gap-2">
			<PageHeading text="View Image" addOnClass="text-left" markedAs="view-img" />
		</div>
		<div class="py-2 mb-5">
			<div class="h-[1px] dark:bg-white bg-slate-900"></div>
		</div>
		<PageHeading text="Đề bài" addOnClass="text-left" markedAs="env" />
		<p className="text-slate-900 dark:text-white mt-5">Dựng UI sau:</p>
		<div class="bg-black px-3 py-3 rounded-lg">
			<div class="grid grid-cols-12">
				<div class="col-span-12 flex items-center justify-center mb-3">
					<img :src="currentImg" alt="" class="rounded" />
				</div>
				<div class="col-span-12 flex items-center gap-3 justify-center">
					<div v-for="(item, index) in listImages" :key="index" class="cursor-pointer" @click="currentImg = item">
						<img :src="item" alt="" class="w-[100px] h-[100px] rounded object-cover" />
					</div>
				</div>
			</div>
		</div>
		<p className="text-slate-900 dark:text-white mt-5">
			Các bạn có thể lấy ảnh bằng việc copy link của từng ảnh (click chuột phải -> copy image address)
		</p>
		...
		<p className="text-slate-900 dark:text-white mt-5">
			...
			<br />
			<br />
			Viết sự kiện copy đường link ảnh khi click vào các ảnh nhỏ ở dưới, sau đó gán đường link vừa copy vào thẻ img lớn
			để hiển thị
		</p>
		<p v-if="false" className="text-slate-900 dark:text-white text-xl mt-5">
...
<script lang="ts">
	...
	import Img1 from '@/assets/images/documentation/parallax-17.jpg';
	import Img2 from '@/assets/images/documentation/parallax-16.jpg';
	import Img3 from '@/assets/images/documentation/parallax-15.jpg';
	import Img4 from '@/assets/images/documentation/parallax-14.jpg';
	...
	export default {
		...
		data() {
			return {
				listImages: [Img1, Img2, Img3, Img4],
				currentImg: Img1,
				listData: [
					{
						id: 1,
