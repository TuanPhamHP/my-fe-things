<template>
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-3 xl:p-6">
		<div class="w-full flex gap-2">
			<PageHeading text="Bài tập PHP - Blade view" addOnClass="text-left" markedAs="env" />
		</div>
		<div class="py-2 mb-5">
			<div class="h-[1px] dark:bg-white bg-slate-900"></div>
		</div>
		<PageHeading text="Đề bài" addOnClass="text-left" markedAs="env" />
		<p className="text-slate-900 dark:text-white mt-5">Sử dụng layout & blade view để dựng UI như sau:</p>
		<div class="py-2"></div>
		...
		<p className="text-slate-900 dark:text-white mt-2 pl-5">
			...
			<br />
			<br />
			Lưu ý: Hiện tại chúng ta chưa cần đến tính năng thêm/sửa/xoá các note. Phần này sẽ được thực hiện vào bài tập buổi
			tiếp theo.
		</p>
