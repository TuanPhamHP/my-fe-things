...
<script lang="ts">
	...
	import CustomerInfomationEditTab from '../../../components/Tabs/CustomerInfomationEditTab.vue';
	export default {
		components: { CustomerInfomationEditTab },
		setup() {
			...
			useHead({
				...
				meta: [{ name: 'description', content: 'Chỉnh sửa thông tin khách hàng' }],
			});
			return {
				api,
				listTabs,
