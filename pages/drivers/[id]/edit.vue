...
<script lang="ts">
	...
	import DriverInfomationEditTab from '../../../components/Tabs/DriverInfomationEditTab.vue';
	export default {
		components: { DriverInfomationEditTab },
		setup() {
			...
			useHead({
				title: 'Chỉnh sửa thông tin lái xe',
				meta: [{ name: 'description', content: 'Chỉnh sửa thông tin lái xe' }],
			});
			return {
				api,
				listTabs,
