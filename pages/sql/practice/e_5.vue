<template>
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-3 xl:p-3 3xl:p-6 pr-0">
		...
		<ul class="pl-10">
			...
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				1. Tạo một VIEW - <FilePath>View_Employee_Department</FilePath> hiển thị danh sách nhân viên cùng tên phòng ban
				của họ.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				2. Tạo một VIEW - <FilePath>View_Project_Participation</FilePath> hiển thị danh sách nhân viên, dự án họ tham
				gia và vai trò trong dự án.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				3. Tạo một VIEW - <FilePath>View_Department_Statistics</FilePath> hiển thị các phòng ban có nhiều nhân viên
				nhất.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-xl text-content marker:text-sky-400 font-bold">
				PROCEDURE
			...
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				1. Tạo PROCEDURE - <FilePath>Get_Employees_By_Department</FilePath> nhận vào <b>department_id</b>và trả về danh
				sách nhân viên thuộc phòng ban đó.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				2. Tạo PROCEDURE - <FilePath>Assign_Employee_To_Project</FilePath> nhận vào
				<b>employee_id, project_id, role</b> để thêm nhân viên vào dự án.
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				3. Tạo PROCEDURE - <FilePath>Get_Top_Employees_By_Project_Count</FilePath> trả về danh sách nhân viên tham gia
				nhiều dự án nhất.
			</li>
		</ul>
...
<script lang="ts">
	...
	export default {
		...
		setup() {
			return usePagination('practice', 'sql-5', 'sql')
		},
		data() {
			return {
...
('Nguyễn Văn Công', 'cong.nv@company.com', '0123456789', '2020-06-15', 1),
('Trần Thị Hạnh', 'hanh.tt@company.com', '0987654321', '2019-03-10', 2),
('Lê Quang Minh', 'minh.lq@company.com', '0912345678', '2021-07-20', 3),
('Phạm Hữu Đức', 'duc.ph@company.com', '0934567890', '2018-09-05', 4),
('Hoàng Thanh Tùng', 'tung.ht@company.com', '0967890123', '2017-12-22', 5),
('Nguyễn Thị Mai', 'mai.nt@company.com', '0971234567', '2019-11-14', 6),
('Đặng Văn Long', 'long.dv@company.com', '0923456789', '2022-05-30', 1),
('Trương Minh Hòa', 'hoa.tm@company.com', '0945678901', '2020-08-25', 2),
('Lý Văn Bảo', 'bao.lv@company.com', '0956789012', '2021-10-12', 3),
('Vũ Thị Lan', 'lan.vt@company.com', '0909876543', '2019-06-17', 4),
('Bùi Văn Dũng', 'dung.bv@company.com', '0981122334', '2018-02-27', 5),
('Đoàn Thị Thanh', 'thanh.dt@company.com', '0912233445', '2020-01-18', 6),
('Trịnh Quốc Việt', 'viet.tq@company.com', '0933445566', '2023-04-08', 1),
('Tống Văn Cường', 'cuong.tv@company.com', '0944556677', '2017-09-19', 2),
('Ngô Thị Hương', 'huong.nt@company.com', '0955667788', '2021-12-05', 3),
('Hà Văn Tài', 'tai.hv@company.com', '0966778899', '2022-07-23', 4),
('Lương Hoàng Sơn', 'son.lh@company.com', '0977889900', '2018-11-15', 5),
('Dương Minh Đức', 'duc.dm@company.com', '0988990011', '2019-08-31', 6),
('Trần Văn Phú', 'phu.tv@company.com', '0999001122', '2020-10-10', 1),
('Lê Thị Nhung', 'nhung.lt@company.com', '0911223344', '2023-02-28', 2);
