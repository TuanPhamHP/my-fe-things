<template>
	<div class="punch-page-wrapper dark:bg-slate-700 bg-white rounded-[24px] p-3 xl:p-3 3xl:p-6 pr-0">
		...
		<ul class="pl-10">
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
				1. Tạo bảng - <FilePath>employee_logs</FilePath> dùng để ghi lại các log liên quan đến việc thêm/sửa thông tin
				nhân viên. Gồm các cột: <b>action, employee_id, causer_id, log_time</b>
			</li>
			<li class="text-slate-900 dark:text-white my-5 leading-8 text-lg text-content marker:text-sky-400 list-disc">
...
<script lang="ts">
	...
	export default {
		...
		setup() {
			return usePagination('practice', 'sql-8', 'sql')
		},
		data() {
			return {
