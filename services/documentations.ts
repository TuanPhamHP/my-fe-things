...
let baseListData: DocumentItem[] = [
	...
	{
		id: 'php-18',
		vneseName: 'Larvel - Eloquent ORM và Query Builder',
		eng: 'AJAX',
		description: 'Làm quen với Eloquent ORM và Query Builder trong Laravel',
		link: '/php/documentation/laravel-orm-and-query-builder',
