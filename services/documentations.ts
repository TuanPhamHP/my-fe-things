...
let baseListData: DocumentItem[] = [
	...
	{
		id: 'php-17',
		vneseName: 'Larvel - Model, Database',
		eng: 'AJAX',
		description: 'Làm việc với Model, Database trong Laravel',
		link: '/php/documentation/laravel-model-database',
		previewImage: 'parallax-17.jpg',
		status_id: 1,
		apps: ['php'],
	},
	{
		id: 'php-18',
		vneseName: 'Larvel - Controller',
		eng: 'AJAX',
		description: 'Làm việc với Controller trong Laravel',
		link: '/php/documentation/laravel-controller',
		previewImage: 'parallax-18.jpg',
		status_id: 1,
		apps: ['php'],
	},
];
