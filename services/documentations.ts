...
const NodeJSBasicDocs = [
	...
	// {
	// 	id: 'node-14',
	// 	vneseName: '[Advanced] - TypeORM | Type Migrations',
	// 	eng: 'Request, Respone nodejs',
	...
	// {
	// 	id: 'node-15',
	// 	vneseName: '[Advanced] - TypeORM | Repository & Query Builder',
	// 	eng: 'Repository & Query Builder in TypeORM',
	// 	description: 'Tìm hiểu Repository và QueryBuilder để truy vấn dữ liệu linh hoạt',
	// 	link: '/nodejs/documentation/typeorm-repository-n-query',
	// 	previewImage: 'course_nodejs.png',
	// 	status_id: 1,
	// 	apps: ['nodejs'],
	// },
	...
	// {
	// 	id: 'node-16',
	// 	vneseName: '[Advanced] - TypeORM | Validate Data',
	// 	eng: 'Validate Data in TypeORM',
	// 	description: 'Validate Data với class-validator',
	// 	link: '/nodejs/documentation/typeorm-class-validator',
	// 	previewImage: 'course_nodejs.png',
	// 	status_id: 1,
	// 	apps: ['nodejs'],
	// },
	{
		id: 'node-17',
		vneseName: 'CommonJS vs ES Module, Lập Trình Bất Đồng Bộ.',
		eng: 'Module, npm nodejs',
		description: 'Làm quen với các dạng module trong NodeJs và lập trình bất đồng bộ.',
		link: '/nodejs/documentation/module-and-async-programming',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	{
		id: 'node-18',
		vneseName: 'Làm việc cơ bản với file JSON.',
		eng: 'Module, npm nodejs',
		description: 'Làm quen với việc đọc/ghi với file JSON trong NodeJs.',
		link: '/nodejs/documentation/json-file-handling',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	...
	{
		id: 'node-5',
		vneseName: 'SERVER, HTTP, REQUEST & RESPONSE',
		eng: 'Request, Respone nodejs',
	...
	{
		id: 'node-7',
		vneseName: 'Express (P2) - Request & Response',
		eng: 'EJS template nodejs',
		description: 'Tìm hiểu và sử dụng Express trong NodeJs phần 2: Request & Response',
	...
	{
		id: 'node-8',
		vneseName: 'Express (P3) – Routing Nâng Cao & Modularization',
		eng: 'Request, Respone nodejs',
		description: 'Tìm hiểu và sử dụng Express trong NodeJs phần 4: Routing Nâng Cao & Modularization',
	...
	{
		id: 'node-9',
		vneseName: 'Express (P4) - Middleware & Error Handling',
		eng: 'EJS template nodejs',
		description: 'Tìm hiểu và sử dụng Express trong NodeJs phần 3: Middleware & Error Handling',
		link: '/nodejs/documentation/expressjs-p4',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	{
		...
		vneseName: 'DotENV',
		eng: 'EJS template nodejs',
		description: 'Sử dụng dotenv để quản lý biến môi trường trong NodeJs',
		link: '/nodejs/documentation/dot-env',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	{
		id: 'node-10',
		vneseName: 'Express (P5) - Mongoose & MongoDB',
		eng: 'EJS template nodejs',
		description: 'Tìm hiểu và sử dụng Express trong NodeJs phần 5: Mongoose & MongoDB',
		link: '/nodejs/documentation/expressjs-p5',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	{
		id: 'node-11',
		vneseName: 'Mongoose - Schema',
		eng: 'EJS template nodejs',
		description: 'Tìm hiểu về Schema trong Mongoose',
		link: '/nodejs/documentation/mongoose-p1',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
	{
		id: 'node-12',
		vneseName: 'Mongoose - Model',
		eng: 'EJS template nodejs',
		description: 'Tìm hiểu về Model trong Mongoose',
		link: '/nodejs/documentation/mongoose-p2',
		previewImage: 'course_nodejs.png',
		status_id: 1,
		apps: ['nodejs'],
	},
...
const PythonBasicDocs = [
	...
	{
		id: 'py-2',
		vneseName: 'Syntax & Identifier trong Python',
		eng: 'Installation',
		description: 'Tổng quan về Python.',
		link: '/python/documentation/syntax-and-identifier',
		previewImage: 'course_python.png',
		status_id: 1,
		apps: ['python'],
	},
	{
		id: 'data-types',
		vneseName: 'Data types',
		eng: 'Installation',
		description: 'Các kiểu dữ liệu phổ biến trong Python.',
		link: '/python/documentation/data-types',
		previewImage: 'course_python.png',
		status_id: 1,
		apps: ['python'],
	},
	{
		...
		vneseName: 'Operators',
		eng: 'Installation',
		description: 'Các toán tử trong Python.',
		link: '/python/documentation/operators',
		previewImage: 'course_python.png',
		status_id: 1,
		apps: ['python'],
	},
...
const SQLBasicDocs = [
	{
		...
		eng: 'RDBMS and SQL',
		description: 'Giới thiệu về RDBMS (Validate Dataal Database Management System) & ER',
	...
	},
	{
		...
		eng: 'RDBMS and SQL',
		description: 'Giới thiệu về một số mô hình phổ biến như Hierarchical, Validate Dataship, Network ...  ',
...
const MongoDBBasicDocs = [
	...
	{
		id: 'mongo-3',
		vneseName: 'D2 - Database',
		eng: 'MongoDB Database',
		description:
			'Tìm hiểu về các thao tác CRUD (Create, Read, Update, Delete) trong MongoDB, cách sử dụng các lệnh cơ bản để thực hiện các thao tác này trên Database.',
		link: '/mongo-db/documentation/mongodb-database',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
	{
		id: 'mongo-4',
		vneseName: 'D2 - Collection',
		eng: 'MongoDB Collection',
		description:
			'Tìm hiểu về các thao tác CRUD (Create, Read, Update, Delete) trong MongoDB, cách sử dụng các lệnh cơ bản để thực hiện các thao tác này trên Collection.',
		link: '/mongo-db/documentation/mongodb-collection',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
	...
	{
		id: 'mongo-6',
		vneseName: 'D4 - Document (P2)',
		eng: 'MongoDB Document',
		description:
			'Tìm hiểu về các thao tác CRUD (Create, Read, Update, Delete) trong MongoDB, cách sử dụng các lệnh cơ bản để thực hiện các thao tác này trên Document.',
		link: '/mongo-db/documentation/mongodb-document-p2',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
	{
		id: 'mongo-7',
		vneseName: 'D4 - Query nâng cao',
		eng: 'MongoDB Document',
		description:
			'Kiến thức nâng cao về Query trong MongoDB, bao gồm các toán tử, lọc dữ liệu, sắp xếp, phân trang và các kỹ thuật tối ưu hóa truy vấn.',
		link: '/mongo-db/documentation/mongodb-query-advanced',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
	...
	{
		id: 'mongo-9',
		vneseName: 'D6 - Aggregation (P2)',
		eng: 'MongoDB Document',
		description: 'Stage $group, $lookup trong Aggregation và Pipeline',
		link: '/mongo-db/documentation/group-and-lookup',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
	{
		...
		vneseName: 'D6 - View',
		eng: 'MongoDB Document',
		description: 'Kiến thức về View trong mongodb',
		link: '/mongo-db/documentation/view',
		previewImage: 'course_mongodb.png',
		status_id: 1,
		apps: ['mongodb'],
	},
