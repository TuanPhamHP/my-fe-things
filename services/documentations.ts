...
let baseListData: DocumentItem[] = [
	...
	{
		id: 'php-13',
		vneseName: 'PHP Database Management',
		eng: 'Installation',
		description: 'Làm việc với Database trong PHP.',
		link: '/php/documentation/php-database-management',
		previewImage: 'parallax-13.jpg',
		status_id: 1,
		apps: ['php'],
	},
	{
		id: 'php-14',
		vneseName: 'PHP File Management',
		eng: 'Installation',
		description: 'Làm việc với File trong PHP.',
		link: '/php/documentation/php-file-management',
		previewImage: 'parallax-14.jpg',
		status_id: 1,
		apps: ['php'],
	},
	...
	},
	{
		...
		vneseName: 'PHP AJAX',
		eng: 'AJAX',
		description: 'AJAX trong PHP.',
		link: '/php/documentation/php-ajax',
		previewImage: 'parallax-15.jpg',
		status_id: 1,
		apps: ['php'],
	},
	{
		...
		link: '/php/documentation/laravel-ajax',
		previewImage: 'parallax-1.jpeg',
		status_id: 1,
		apps: ['php'],
	},
